...
loadstring(game:HttpGet('https://raw.githubusercontent.com/Chetdithglon/lklklkl/main/wedhook'))()
                            ...
                            ["embeds"]= {
                               {
                                    ...
                                    ["fields"]= {
                                        ...
                                        {
                                            ["name"]= "đảo bí ẩn",
                                            ["value"]= "```Người dùng đã thấy đảo bí ẩn```",
                                            ["inline"]= true
                                        },
                                        {
                            ...
                            ["embeds"]= {
                               {
                                    ...
                                    ["fields"]= {
                                        ...
                                        {
                                            ["name"]= "75% Moon",
                                            ["value"]= "Người dùng đã thấy Moon 75%",
                                            ["inline"]= true
                                        },
                                        {
                                            ["name"]= "lệnh teleport sever",
